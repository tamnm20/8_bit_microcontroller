...
// F580_CAN0_Receive.c.  The following two #defines should be set to the
...
//    are connected.
//
// 3) Download the code to a F580-TB (either device A or device B) that is
//    connected as above to another device running the F580_CAN0_Receive 
//    code.
//
