...
// Program Description:
//
// This program tests all the functions available in F580_FlashPrimitives.c
// and F580_FlashUtils.c.  It uses a test data array to mimic the changes
...
//
// Option 1:
// 1) Load the F580_Flash_test.c, F580_FlashPrimitives.c, and F580_FlashUtils.c
//    files in the Silicon Labs IDE.
// 2) Compile and download code to a 'F580 device.
// 3) Verify the LED pin of J13 are populated on the 'F580 TB.
// 4) Run the code
...
void main (void)
{
   ...
   for (i = 0; i < sizeof(test_write_buff); i++)
   {
	 ...
	 FLASH_Update(0x0003, test_write_buff2, 3);
   //--------------------------------------------------------------------------
